...
extension SupportingMethods {
    ...
    func isEqualOrLaterThanTargetDate(_ date: Date = Date(), targetDate: Date, timeZone: TimeZone = TimeZone(abbreviation: "KST")!, locale: Locale = Locale(identifier: "ko_KR")) -> Bool {
        var calendar = Calendar.current
        calendar.locale = locale
        calendar.timeZone = timeZone
